...
[image0]: ./examples/input.jpg "Input"
...
make features of the images more apparent. Normalising the image values also helps in converging te gradients faster. 
...
2. Grayscaling: To simplify and make training process efficient, I have converted the normalised images from RGB to grayscale. 
